...
.col-form-label{
 ...
 <body onload="getEmployee();serachOnLoad('I');"> 
	 ...
	 <div class="container-fluid">
		...
		<div class="page-header" id="ftitleHeader">
			<div class="row">
				...
				<div class="col-sm-12">
					<h4 class="hfont"><fmt:bundle basename="filemovement"><fmt:message key="dak_inward_movement.header" /></fmt:bundle></h4>
				</div>

			</div>
		</div>

   <form class="form-horizontal" name="dak_inward" id="dak_inward"  method="post" autocomplete="off">
	  <div class="panel panel-default">
		<div class="panel-heading">
           ...
           <div class="panel-body">
			  <div class="form-group">
		       <div class="col-md-12">
		         <div class="row">
					   <label class="col-sm-2 col-form-label " for="employee"><fmt:bundle basename="filemovement"><fmt:message key="dak_inward_movement.emp" /></fmt:bundle></label>
						 <div class="col-sm-4">
				         ...
				         <label class="col-sm-2 col-form-label" for="designation"><fmt:bundle basename="filemovement"><fmt:message key="dak_inward_movement.designation" /></fmt:bundle></label>
						 <div class="col-sm-4">
		...
		<div class="form-group">
		 <div class="col-md-12">
          ...
          <label for="endDate" class="col-sm-2 col-form-label"><fmt:bundle basename="filemovement"><fmt:message key="dak_inward_movement.to_dt" /></fmt:bundle></label>
        	 <div class="col-sm-4">
	...
	<div class="form-group">
		<div class="col-md-12">
			<div class="row">
				<label for="SEARCHDETAIL" class="col-sm-2 col-form-label" ><fmt:bundle basename="filemovement"><fmt:message key="dak_inward_movement.subject" /></fmt:bundle></label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="searchDetail" name="searchDetail" 
							maxlength="100" placeholder="Subject keyword/Dak No." >
				    </div>
          	</div>
        </div>
     </div>
	          ...
	          <div class="form-group m-t-25 m-b-5">
		         <div class="col-md-12 text-center">
			       <div class="row">
				     <button type="button" class="btn btn-view" id="btnSearch"
				      data-toggle="collapse" data-parent="#accordion" href="#collapseBody_1">Search</button>
       ...
       <iframe class="embed-responsive-item" name="frm_file_inward_l" id="frm_file_inward_l" width="100%;" height="550px"  src="" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	  </iframe>   
