 ...
 <body>
	...
	<div id="searchingTable" class=" scr0">
	   ...
	   <div class="page-header-1 head-1">
		    <div class="col-sm-4 repTitle title-1">Dak Life Cycle(s)</div>
	...
	<c:set var="count" value="${count+1}"></c:set>
		      ...
		      <tr>
			     ...
			     <td style="text-align:center;width:20%;">${lifecycle.getSenderId()}</td>
			     ...
			     <td style="text-align:center;width:8%;">${lifecycle.getCreated()}</td>
			     <%-- <td style="text-align:center;width:10%;">${lifecycle.getReceived_date()}</td> --%>
			     <td style="text-align:center;width:20%;">${lifecycle.getReceiverId()}</td>
			    ...
			    <%--  <td style="text-align:center;width:10%;">${lifecycle.getTo_location()}</td> --%>
		         ...
		         <input type="hidden" id="fileid" name="fileid" value="${lifecycle.getFile_creation_id()}"></td>
