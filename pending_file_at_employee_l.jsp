 ...
 <body>
	...
	<c:set var="count" value="${count+1}"></c:set>
		      <tr>
			     ...
			     <td style="text-align:center;width:25%;">${pendingEmp.getRecived_emp()}</td>
		         <td style="text-align:center;width:25%;">${pendingEmp.getTotal_file()}</td>
			     <td style="text-align:center;width:25%;text-decoration:underline"><a href="#" class="fileDetails" onclick="getDetails('${pendingEmp.getReceiverId()}');">File Details</a></td>
			     <!-- <td style="text-align:center;width:20%;text-decoration:underline"><a href="#">Print</a></td> -->
	     	 </tr>
	     	 <input type="hidden" id="fileid" name="fileid" value="">
	     	 <input type="hidden" id="emp_id" name="emp_id" value="${pendingEmp.getReceiverId()}">
	     	 </c:forEach>  
      </tbody>
	</table>
	  </div>
	...
	<table id="searchTable1" class="table table-striped table-bordered table-hover display nowrap" cellspacing="0" width="100%">
			<thead class="theadnew">
			<tr>
				<th class="text-center">S.No.1</th>
	...
	<c:set var="count" value="${count+1}"></c:set>
		      <tr>
			     ...
			     <td style="text-align:center;width:15%;text-decoration:underline" onclick="view(${pendingEmp.getFmt_id()});"><a href="#">View Details</a></td>
		         <td style="text-align:center;width:15%;text-decoration:underline" onclick="showlifecycle(${pendingEmp.getFmt_id()});"><a href="#">Life Cycle</a></td>
	     	 </tr> 
	     	 <input ty pe="hidden" id="emp_id" name="emp_id" value="${pendingEmp.getRecived_emp()}">
	     	 </c:forEach> 
       </tbody>
	</table>
	</div> --%>
	...
	<script>
      ...
      <iframe class="embed-responsive-item" name="pendingfileview" id="pendingfileview" width="100%;" height="1000px" src="" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	  </iframe>
	  <iframe class="embed-responsive-item" name="pending_file_view" id="pending_file_view" width="100%;" height="1000px" src="" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	  </iframe>
  </body>
</html> 