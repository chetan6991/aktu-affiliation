...
<script type="text/javascript"
	src="../resources/js/filemovement/dak_employee_mapping.js"></script>
...
<body onload="getfiletype('');getsearchlist();">
	<div class="container-fluid">
		<div id="" class="page-header">
			<h4><fmt:bundle basename="filemovement"><fmt:message key="create_and_manage_hierarchy_level.header" /></fmt:bundle></h4>
		</div>
