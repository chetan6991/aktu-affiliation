...
<body onload="getEmployee();getDepartment();">
	 <div class="container-fluid">
		<div class="page-header" id="ftitleHeader">
			<div class="row">
				<div class="col-sm-12">
					<h4>Pending File at Employee Level</h4>
				</div>
			</div>
		</div>
   <form class="form-horizontal" name="pending_Emp" id="pending_Emp" method="post" autocomplete="off">
	  ...
	  <div><br></div> 
		    <div class="form-group">
		       <div class="col-md-12">
		         <div class="row">
					   <label class="col-sm-2 col-form-label " for="">Location</label>
				         ...
				         <label class="col-sm-2 col-form-label" for="">Received Department</label>
						 <div class="col-sm-4">
				    		<select class="form-control" id="recDeprt" name="recDeprt" >
		     ...
		     <div class="form-group">
		       <div class="col-md-12">
		         <div class="row">
					   <label class="col-sm-2 col-form-label " for="">Received By</label>
						 <div class="col-sm-4">
				         ...
				         <label class="col-sm-2 col-form-label" for="psd">Pending since Days</label>
						 <div class="col-sm-4">
				    		<input type="text" class="form-control" id="psd" name="" placeholder="Enter Pending since Days">
				         </div>
					</div>
		        </div>
		    </div> 
		<div class="form-group">
		 <div class="col-md-12">
			<div class="row">
			   <label class="col-sm-2 col-form-label " for="">Received Date </label>
    		   <label for="startDate" class="col-sm-1 col-form-label" for="msg-XSTARTDATE">From Date</label>
     			  <div class="col-sm-3">
     ...
     <div class="form-group">
		 <div class="col-md-12">
           ...
           <label class="col-sm-2 col-form-label " for=""> </label>
    		   <label for="startDate" class="col-sm-1 col-form-label" for="msg-XENDDATE">To Date</label>
     			  <div class="col-sm-3">
				      <div class="input-group date" id="msg-XENDDATE">
							<div class="input-group-addon">
							 <i class="fa fa-calendar"></i>
							</div>
							<input placeholder="DD/MM/YYYY" readonly="readonly" data-field-id=" " type="text"  class="form-control datecalendar from_date" 
       ...
       <iframe class="embed-responsive-item" name="frmpendingemp" id="frmpendingemp" width="100%;" height="2000px" src="" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	  </iframe>  
