...
<head>
 ...
 <body>
	<form name="fileforApprovall2" id="fileforApprovall2" action="" method="post" autocomlete="off">
	<div id="searchingTable" class=" scr0">
	   ...
	   <div class="page-header-1">
		    <div class="col-sm-4 repTitle "> 
		    <c:choose>
		 	<c:when test="${mode=='V'}"><span>File Life Cycle for file for Approval</span></c:when>
				<c:otherwise><span>File Life Cycle for Approved File</c:otherwise>
					</c:choose>		
           </div>
