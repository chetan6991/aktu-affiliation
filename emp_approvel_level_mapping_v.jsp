...
<form name="empapprovv" id="empapprovv"  method="post" autocomlete="off">
...
<div class="col-sm-12">
			...
			<div class="page-header-1">
				<div class="col-sm-4 repTitle h5 ">List of Employee(s) level</div>
    ...
    <table id="searchTable" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="">
			<thead>
				<tr>
					...
					<th class="text-center">Employee Name (Code)</th>
	...
	<tr>
		...
		<td class="text-center">${data.getOrder()}</td>
		<td class="text-center"><span id="${count}" ></span>${data.getEmpname()}</td>
			...
			<!-- <tbody>
                <tr>
					...
					<td style="text-align:center; width:30%;">aa</td>
					<td style="text-align:center; width:30%;"><a href="">6</a></td>
					<td class="colr-blue-p" style="width:20%;"><span id="" onClick=""><i class="fa fa-edit p-l-3"></i>Edit</span></td>
	   				<td class="colr-red-p" style="width:20%;"><span id="" onClick=""><i class="fa fa-trash p-l-3"></i>Delete</span></td>
				 </tr>
			</tbody> -->
		</table>
			<div class="col-md-12 text-center m-t-20">
					<button type="button" class="btn btn-view" onclick="onlist();">Back</button>
				</div>
	</div>
