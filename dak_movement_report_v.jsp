   				...
   				<%-- <div class="form-group">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-sm-3">
							<label><a target="_blank" href="../downloadfile?filename=${file.getAttachmentid()}_${file.getFilename()}&folderName=${file.getFile_creation_id()}&FileType=D">
