...
<%@page import="com.sits.fms.reports.dak_movement_report.DakMovementReportModel"%>
<%@page import="com.sits.fms.reports.dak_movement_report.DakMovementReportManager"%>
...
.btn-view {
  ...
  <%
	try{
			    ...
			    response.setHeader("Content-Disposition","attachment; filename=\"" + "Dak LifeCycle.pdf\"");
				 String headerName = "Dak LifeCycle Report";
				 ...
				 DakMovementReportModel model=new DakMovementReportModel();
				List<DakMovementReportModel> list= DakMovementReportManager.PDFReport(model,session1,fileId);
				...
				float[] headerWidth = {1.2f,8f};
				 ...
				 float[] headerListWidth = {0.8f, 1.2f, 1.2f, 1.2f};
