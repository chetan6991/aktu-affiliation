			...
			<!-- 	Insert code here  -->
	 			...
	 			<c:if test="${forDraft ne 'D'}">
		 			<iframe class="embed-responsive-item" name="file_mov_view" id="file_mov_view" width="100%;" height="" 
	 					frameborder="0" scrolling="no" style="min-height:715px !important;max-height:1000px!important;">
	 				</iframe>
	 			</c:if>
	 			<c:if test="${forDraft eq 'D'}">
	 				<iframe class="embed-responsive-item" name="file_mov_view" id="file_mov_view" width="100%;" height="" 
	 					frameborder="0" scrolling="no" style="min-height:501px !important;max-height:1000px!important;">
	 				</iframe>
	 			</c:if>
<%-- 	 			${viewList}
