...
<!-- <body onload="getEmployee();"> -->
	 <div class="container-fluid">
		...
		<div class="page-header" id="ftitleHeader" style="padding: 0px !important;">
			<div class="row">

				<div class="col-sm-12">
					<h4 style="font-size:15px;"><fmt:bundle basename="filemovement"><fmt:message key="file_inward_movement.header" /></fmt:bundle></h4>
				</div>
	...
	<div class="form-group">
		<div class="col-md-12">
			<div class="row">
		     ...
		     <input type="hidden" name="desgination_id" id="desgination_id" value="<%=desg_id%>"> 
	     	 <input type="hidden" name="desg_id" id="desg_id" value="<%=desg_id%>">
        </form>
       <iframe class="embed-responsive-item" onload="resizeIframe(this)"  name="frm_file_inward_l" id="frm_file_inward_l" width="100%;" height=""  src="" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	  </iframe>   
