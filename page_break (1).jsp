...
<div class="container-fluid">
   <div id="" class="page-header"><h4>File Inbox</h4></div>
 	 ...
 	 <!-- ----------------------------Start 1st Panel-------------------------------------- -->
	 	...
	 	<!-- 		<div class="form-group">
	 	 ...
	 	 <div class="" id="">
				...
				<div class="panel-body" style="height: 786px;width: 100%; padding:10px 2px 10px 2px; ">
				
				 
			<!-- 	Insert code here  -->
	 			<div id="xyz">
	 			<div id="abc" style="width:100% !important">	
	 			<iframe class="embed-responsive-item" name="file_mov_view" id="file_mov_view" width="100%;" height="760px" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	            </iframe>
<%-- 	 			${viewList}
 --%>	 			<%--  <c:forEach items="${viewList}" var="model">
    ...
    <div class="col-sm-8" style="margin-top:20px;margin-bottom:20px;padding:0px;">
    ...
    <%--For displaying Next link --%>
		...
		<div class="col-sm-4 text-right" style="padding:0px;margin-top: 4px;">
		   <a href="#" onclick="getpdf('${view.getFile_creation_id()}');"data-toggle="tooltip" data-placement="top"
		       title="" data-original-title="Click here for download the Notes"
		       class="red-tip">
                     <b style="border: 1px solid green; border-radius: 7px; padding: 4px 4px; background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#437386), color-stop(100%,#78B9D2));
					   color: #002534;">PRINT NOTES</b></a>
		</div>
	</div>
...
<!-- ----------------------------Start 2nd Panel-------------------------------------- -->			   
			...
			<div class="col-md-6" style="padding: 0px 5px 0px 0;display: inline-flex !important;">
			<div class="panel-body" style="height: 790px; overflow-y: auto;padding:0px;">       
    ...
    <!-- Modal -->
       ...
       <%-- <div class="form-group">
		...
		<div id="" style="width:100%; padding-top:20px;">
						...
						<thead>
							<tr>
								<th style="text-align:center;width:20%;">DAK No.</th>
				  				...
				  				<th style="text-align:center;width:25%;">DAK Name</th>
				  				<th style="text-align:center;width:10%;">Delete</th>
							</tr>
						</thead>
						<tbody id="searchTableDAK">	
							<tr>
									<td class="text-left" style="font-family: Calibri, courier-new,sans-serif; font-size: 13px; width:23%;">
										<select  class="form-control" id="dakId1" name="dakId1" style="width:95%; text-align: center;" onchange="getlink(this.value, '1');">
											<option value="">Select DAK No.</option>
							        			<c:forEach items="${DAK_NO}" var="dak">
							        				<%-- <c:choose>
														<c:when test="${dak.getDakId() eq dk_id}">
       ...
       <div id="" style="width:100%; padding-top:20px;">
       		<div class="col-xs-12" style="padding:0px;display:flex;">
				<div class="table-responsive" style="width:100%;display: contents;">
					<table border="1" cellspacing="1" cellpadding="1" width="100%" class="tableGrid">
					<thead>
				<tr>
					<th style="text-align:center;width:20%;">Document Title</th>
			  		<th style="text-align:center;width:35%;">Upload Document
			  		 <p class="" style="font-size: 13px !important; font-weight: bold; color: red;margin: 0px 0 0px;">(Max. Size Cannot Exceed 20MB) 
			  		 (Note: Only .pdf, .jpg, .png, & doc files will be allowed for uploading)</p></th>
	      		...
	      		<div class="errmessage" id="errMsg"></div>
					 ...
					 <div class="form-group m-t-25 m-b-5">
						<div class="col-md-12 text-center">
					        ...
					        <button type="button" class="btn btn-view sentColr" id="btnSent" <c:if test="${view.getNote()==''}"> style="display: none;"  </c:if>>Sent File</button>
