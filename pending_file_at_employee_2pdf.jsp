...
<script src="../resources/assets/sits/bootstrap/3.3.7/js/bootstrap.min.js"></script>
  ...
  <%
	try{
				...
				System.out.println("list size  pdf  "+list.size());
				System.out.println("list size    "+list);
				System.out.println("list size    "+list.get(0).getCreated_by());
				...
				float[] headerWidth = {1.2f,8f};
				 ...
				 float[] headerListWidth = {3.2f, 4f, 1f, 1f,3.2f,4f};
				 ...
				 float[] headerListWidth1 = {3.2f, 6f,4f};
				 PdfPTable HeaderListTable1 = new PdfPTable(headerListWidth1);
				 HeaderListTable1.setSpacingAfter(20);
				 HeaderListTable1.setWidthPercentage(95f);
				 HeaderListTable1.setSpacingBefore(20);
				 ...
				 PdfPCell cell;  	
				   ...
				   // ============   Start headerWidth ================================= 
				    ...
				    cell = new PdfPCell(new Phrase(ReadProps.getkeyValue("welcome.header","filemovement"),myVerdanabFontB12));
				    cell.setColspan(1);
				    cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				    cell.setBorderColor(new BaseColor(255, 255, 255));
				    headerTable.addCell(cell);
				...
				/*  cell = new PdfPCell(new Phrase(headerName,myVerdanabFontB10));
				 ...
				 cell = new PdfPCell(new Phrase("File Id",myVerdanabFontB09));
		         cell.setColspan(1);
		    	 cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		    	 cell.setBorderColor(new BaseColor(255, 255, 255));
		    	 ...
		    	 cell = new PdfPCell(new Phrase("Dispatch No.",myVerdanabFontB09));
		         cell.setColspan(1);
		    	 cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		    	 cell.setBorderColor(new BaseColor(255, 255, 255));
		    	 HeaderListTable.addCell(cell);
		    	 ...
		    	 cell = new PdfPCell(new Phrase(": "+list.get(0).getCreated_by(),myVerdanaFontB10)); 
		         cell.setColspan(1);
		    	 cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		    	 cell.setBorderColor(new BaseColor(255, 255, 255));
		    	 HeaderListTable.addCell(cell);
		    	 ...
		    	 cell = new PdfPCell(new Phrase(": "+list.get(0).getCreated_for_department(),myVerdanaFontB10)); 
		         cell.setColspan(1);
		    	 cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		    	 cell.setBorderColor(new BaseColor(255, 255, 255));
		    	 HeaderListTable.addCell(cell);
        ...
        System.out.println("pending_file_at_employee [PDFReport] "+e);
	    }
