 ...
 <body onload="getEmployee();">
   ...
   <form class="form-horizontal" name="file_inward" id="file_inward" target="" method="post" autocomplete="off">
	 ...
	 <div class="panel-body">
        	 ...
        	 <div class="col-sm-4">
	          ...
	          <div class="form-group m-t-25 m-b-5">
		         <div class="col-md-12 text-center">
			       <div class="row">
				     <button type="button" class="btn btn-view" id="btnSearch2">Search</button>
      ...
      <iframe class="embed-responsive-item" name="frm_file_inward_l" id="frm_file_inward_l" width="100%;" height="1000px" src="" frameborder="0" scrolling="no" style="overflow-y: hidden;">
