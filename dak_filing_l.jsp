...
<form name="empapprovl" id="empapprovl" method="post" autocomplete="off">
...
<div class="col-sm-12">
    ...
    <table id="searchTable" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="">
			<thead>
				<tr>
					...
					<th class="text-center">From Designation</th>
					<th class="text-center">To Employee</th>
					<th class="text-center">To Department</th>
					<th class="text-center">To Designation</th>
	...
	<tr>
		...
		<td class="text-center">${data.getFromEmpName()}</td>
		<td class="text-center">${data.getFromDeptName()}</td>
		<td class="text-center">${data.getFromDesiName()}</td>
		<td class="text-center">${data.getToEmpName()}</td>
		<td class="text-center">${data.getToDeptName()}</td>
		<td class="text-center">${data.getToDesiName()}</td>
		
		<td  class="text-center colr-blue-p" style="width: 15%;"><span id="EDIT_RECORD_${count}" 
		onclick="editRecord('${data.getFrom_employee()}','${data.getFrom_department()}','${data.getFrom_designation()}',
		                    '${data.getTo_employee()}','${data.getTo_department()}','${data.getTo_designation()}') ;">
		<i  class="fa fa-edit p-l-3"></i>Edit</span></td>
		<td style="text-align:center;color:RED;cursor:pointer; width:15%; " onclick="delRecord('${data.getFrom_employee()}','${data.getFrom_department()}','${data.getFrom_designation()}',
																								'${data.getTo_employee()}','${data.getTo_department()}','${data.getTo_designation()}') ">
