...
<div class="col-sm-12">
			...
			<div class="page-header-1">
				<div class="col-sm-4 repTitle h5 ">List of Group(s)</div>
	...
	<tr>
		...
		<%-- <td class="text-center">${data.getFileTypeName()}</td> --%>
		<td class="text-center">${data.getGroup()}</td>
		
		<td  class="text-center colr-blue-p" style="width: 15%;"><span id="EDIT_RECORD_${count}" 
		onclick="editRecord('${data.getFiletype()}','Y','${data.getGroup()}') ;">
		<i  class="fa fa-edit p-l-3"></i>Edit</span></td>
		<td style="text-align:center;color:RED;cursor:pointer; width:15%; " onclick="delRecord('${data.getFiletype()}','Y','${data.getGroup()}') ">
    	    ...
    	    var t = $('#searchTable').DataTable( {
        	  ...
        	  "<'row'<'col-sm-5'i><'col-sm-7'p>>", 
	        	buttons: [
	            	{	
   	                	extend: 'excelHtml5',
   	                	filename: 'Create And Manage Group List',
   	                	title:'Create and Manage Group',
