...
<body onload="getEmployeeForSearch();serachnew();">
	<div class="container-fluid">
		...
		<div id="ftitleHeader" class="page-header">
			<h4><fmt:bundle basename="filemovement"><fmt:message key="file_outward_movement.header" /></fmt:bundle></h4>
		</div>
   ...
   <form class="form-horizontal" name="fileoutward" id="fileoutward" target="_Report" method="post" autocomplete="off">
	 ...
	 <div class="panel-body">	 
	 		  <%--  <div class="form-group">
	              <div class="col-md-12">
	                <div class="row">
		               <label class="col-sm-2 col-form-label panhed left" for="search"><fmt:bundle basename="filemovement"><fmt:message key="file_outward_movement.search" /></fmt:bundle></label>
		                 <div class="col-sm-2">
		    ...
		    <div class="form-group">
		       <div class="col-md-12">
		         <div class="row">
					  <%-- <label class="col-sm-2 col-form-label" for="fileID"><fmt:bundle basename="filemovement"><fmt:message key="file_outward_movement.id" /></fmt:bundle></label>
						  <div class="col-sm-4">
							  <input type="text" class="form-control" id="fileID" name="fileID" placeholder="Enter File ID" value="">  
						  </div>
				         
					    <label class="col-sm-2 col-form-label" for="manualfileNo"><fmt:bundle basename="filemovement"><fmt:message key="file_outward_movement.man_no" /></fmt:bundle></label>
						   <div class="col-sm-4">
								 <input type="text" class="form-control" id="manualfileNo" name="manualfileNo" placeholder="Enter Manual File No." value="">  
						  </div> --%>
			...
			<!-- <div class="form-group">
	       		<div class="col-md-12">
	            	<div class="row"> -->
		               <%-- <label class="col-sm-2 col-form-label" for="subject"><fmt:bundle basename="filemovement"><fmt:message key="file_outward_movement.subject" /></fmt:bundle></label>
						  <div class="col-sm-4">
							  <input type="text" class="form-control" id="subject" name="subject" placeholder="Enter Subject" value="">  
						  </div>
						  
					   <label class="col-sm-2 col-form-label " for="forlocation"><fmt:bundle basename="filemovement"><fmt:message key="file_outward_movement.for_lctn" /></fmt:bundle></label>
						 <div class="col-sm-4">
				    		<select class="form-control" id="forlocation" name="forlocation" >
				    		<option value=""></option>
				            </select>
				         </div> --%>
				   <!--       <label class="col-sm-2 col-form-label" for="">Location</label>
						 	<div class="col-sm-4">
				    			<select class="form-control" id="loc" name="loc" disabled>
							 		<option value="">Select Location</option>				   				
				            	</select>
				         	</div>
			         	<label class="col-sm-2 col-form-label" for="">Department</label>
					 		<div class="col-sm-4">
			    				<select class="form-control" id="dpt" name="dpt" disabled>
       ...
       <iframe class="embed-responsive-item" name="_Report" id="_Report" width="100%;" height="460px" src="" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	  </iframe>  
