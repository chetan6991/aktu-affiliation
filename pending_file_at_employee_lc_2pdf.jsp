<%@page import="com.sits.fms.reports.pending_file_at_employee.PendingFileEmployeeModel"%>
...
<%@ page import="com.sits.fms.reports.pending_file_at_employee.PendingFileEmployeeController"%>
<%@ page import="com.sits.fms.reports.pending_file_at_employee.PendingFileEmployeeManager"%>
  ...
  <%
	try{
			    ...
			    response.setHeader("Content-Disposition","attachment; filename=\"" + "File_Detail.pdf\"");
				 ...
				 PendingFileEmployeeModel model=new PendingFileEmployeeModel();
				List<PendingFileEmployeeModel> list= PendingFileEmployeeManager.PDFReport(model,session1,FileId);
				...
				/*  cell = new PdfPCell(new Phrase(headerName,myVerdanabFontB08));
		    	 ...
		    	 cell = new PdfPCell(new Phrase("Send Department",myVerdanabFontB08));
		         cell.setColspan(1);
		         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				 cell.setBorderColor(new BaseColor(0, 0, 0));
				 cell.setBackgroundColor(new BaseColor(226,226,226));
		    	 ...
		    	 cell = new PdfPCell(new Phrase("Received Date",myVerdanabFontB09));
		         cell.setColspan(1);
		         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				 cell.setBorderColor(new BaseColor(0, 0, 0));
				 cell.setBackgroundColor(new BaseColor(226,226,226));
		    	 ...
		    	 cell = new PdfPCell(new Phrase("Received Department",myVerdanabFontB08)); 
		         cell.setColspan(1);
		         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				 cell.setBorderColor(new BaseColor(0, 0, 0));
				 cell.setBackgroundColor(new BaseColor(226,226,226));
		    	 ...
		    	 for(int i=0;i<list.size();i++){
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getSenderId(),myVerdanaFontB08));
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
					 cell.setBorderColor(new BaseColor(0, 0, 0));
					 //cell.setBorderWidthLeft(0.5f);
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getSender_dpt(),myVerdanaFontB08));
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
					 cell.setBorderColor(new BaseColor(0, 0, 0));
					 //cell.setBorderWidthLeft(0.5f);
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getSender_loc(),myVerdanaFontB08));
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			     	 cell.setBorderColor(new BaseColor(0, 0, 0));
			    	 cell.setBorderWidthRight(0.5f);
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getCreated(),myVerdanaFontB08)); 
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			     	 cell.setBorderColor(new BaseColor(0, 0, 0));
			    	 cell.setBorderWidthRight(0.5f);
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getReceived_date(),myVerdanaFontB08));
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			     	 cell.setBorderColor(new BaseColor(0, 0, 0));
			    	 cell.setBorderWidthRight(0.5f);
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getReceiverId(),myVerdanaFontB08)); 
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			     	 cell.setBorderColor(new BaseColor(0, 0, 0));
			    	 cell.setBorderWidthRight(0.5f);
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getTo_department(),myVerdanaFontB08)); 
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			     	 cell.setBorderColor(new BaseColor(0, 0, 0));
			    	 cell.setBorderWidthRight(0.5f);
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getTo_location(),myVerdanaFontB08)); 
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			     	 cell.setBorderColor(new BaseColor(0, 0, 0));
			    	 cell.setBorderWidthRight(0.5f);
			    	 ...
			    	 cell = new PdfPCell(new Phrase(""+list.get(0).getRemarks(),myVerdanaFontB08));
			         cell.setColspan(1);
			         cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			     	 cell.setBorderColor(new BaseColor(0, 0, 0));
			    	 cell.setBorderWidthRight(0.5f);
