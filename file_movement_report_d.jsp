...
<meta name="viewport" content="width=device-width, initial-scale=1">
 ...
 <script type="text/javascript">
	...
	function callModal(file_creation_id,file_type,fmt_id,tibcoserverUrl,tibcoserverUsername,tibcoserverPassword)
	{
		   // var file_creation_id=1;
			...
			if(file_type == 'F'){jaspername="fms_file_creation";}
   ...
   <body onload="load(); serachnew();">
	   <div class="container-fluid">
		  <div class="page-header" id="ftitleHeader">
			 <div class="row">
				<div class="col-sm-12">
					<h4 class="hfont">File Movement Report</h4>
				</div>
			</div>
		</div>
 ...
 <form class="form-horizontal" name="filereport" id="filereport" method="post" autocomplete="off">
   <div class="panel panel-default">
	 ...
	 <div class="panel-body">
		       ...
		       <div class="col-md-12">
		         <div class="row">
					   <label class="col-sm-2 col-form-label required-field" for="">Received / Sent</label>
				         ...
				         <label class="col-sm-2 col-form-label " for="subject">Dispatch No.</label>
						<div class="col-sm-4">																			
						<input type="text" class="form-control" id="Mfile_no" name="Mfile_no"  placeholder="Enter Dispatch No." >
						</div>
					</div>
		        </div>
		    </div> 
		...
		<div class="form-group">
		 <div class="col-md-12">
	      ...
	      <input type="hidden" name=hrmsApi id="hrmsApi" value="<fmt:bundle basename="filemovement"><fmt:message key="hrms-api.url" /></fmt:bundle>">
	   		...
	   		<input type= "hidden" id="desigId" name="desigId" value='<%=desg_id %>'>
      ...
      <form class="form-horizontal" name="fileMovementFrmModal" id="fileMovementFrmModal" method="" autocomplete="off">
