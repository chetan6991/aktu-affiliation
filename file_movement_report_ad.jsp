...
<style type="text/css">
 ...
 <body>
	<form name="filemovementad" id="filemovementad" action="" method="post" autocomlete="off">
	<div id="searchingTable" class=" scr0">
	   ...
	   <div class="page-header-1 head-1">
		    <div class="col-sm-4 repTitle title-1">List Of Files Attached</div>
	   ...
	   <table id="searchTable" class="table table-striped table-bordered table-hover display nowrap " cellspacing="0" width="100%">
		     <thead class="theadnew">
					<tr>
						...
						<!-- <th class="text-center">File Attachment Id</th> -->
       		...
       		<c:set var="count" value="0"></c:set>
				...
				<c:forEach items="${file_attachment}" var="file_attachment"> 					
					<c:set var="count" value="${count+1}"></c:set>
		
		      <tr>		      
			     <td style="text-align:center;width:5%;">${count}</td>
			     <%-- <td style="text-align:center;width:20%;">${file_attachment.getFile_creation_id()}</td> --%>
			     <td style="text-align:center;width:20%;"><b>${file_attachment.getFilename()}</b></td>
			     <td style="text-align:center;width:20%;">${file_attachment.getDoctitle()}</td>
			     <td style="text-align:center;width:20%;"><a target="_blank" href="../downloadfile?filename=${file_attachment.getAttachmentid()}_${file_attachment.getFilename()}&folderName=${file_attachment.getFile_creation_id()}">
							<b><u>${file_attachment.getDoctitle()} (${file_attachment.getFilename()})</b></u></a> </td>
		         <input type="hidden" id="fileid" name="fileid" value="${file_attachment.getFile_creation_id()}"></td>
	     	 </tr> 
  	   ...
  	   <div class="form-group m-t-25 m-b-5">
		         <div class="col-md-12 text-center">
			       <div class="row">
				     <button type="button" class="btn btn-view" id="btnBack3" >Back</button>
