...
.col-form-label{
 ...
 .container-fluid { width: 100%;padding-bottom: 50px !important;}
</style>
</head>
	 ...
	 <div class="container-fluid">
		...
		<div class="page-header" id="ftitleHeader">
			<div class="row">
				...
				<div class="col-sm-12">
					<h4 class="hfont">File Safe Custody</h4>
				</div>

			</div>
		</div>

   <form class="form-horizontal" name="file_Archive" id="file_Archive" target="" method="post" autocomplete="off">
	...
	<div class="form-group">
       ...
       <iframe class="embed-responsive-item" onload="resizeIframe(this)" name="frm_file_Archive_l" id="frm_file_Archive_l" width="100%;" height=""  src="" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	  </iframe>   
