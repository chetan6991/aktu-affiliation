 	 ...
 	 <!-- ----------------------------Start 1st Panel-------------------------------------- -->
	 	...
	 	<!-- 		<div class="form-group">
	 	 ...
	 	 <div class="" id="">
				...
				<div class="panel-body" style="height: 561px;width: 100%; padding:10px 2px 10px 2px; ">
				
				 
			<!-- 	Insert code here  -->
	 			<div id="xyz">
	 			<div id="abc" style="width:100% !important">	
	 			<iframe class="embed-responsive-item" name="file_mov_view" id="file_mov_view" width="100%;" height="550px" frameborder="0" scrolling="no" style="overflow-y: hidden;">
	            </iframe>
<%-- 	 			${viewList}
...
<!-- ----------------------------Start 2nd Panel-------------------------------------- -->			   
			...
			<div class="col-md-6" style="padding: 0px 5px 0px 0;">
			<div class="panel-body" style="height: 630px; overflow-y: auto; overflow-x: hidden; padding:0px;">       
    ...
    <!-- Modal -->
       ...
       <%-- <div class="form-group">
		...
		<div id="" style="width:100%; padding-top:5px;">
