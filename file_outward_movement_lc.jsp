 ...
 <table id="searchTable1" class="table table-striped table-bordered table-hover display nowrap" cellspacing="0" width="100%">
     <thead class="theadnew">
			<tr>
			    ...
			    <th class="text-center"><fmt:bundle basename="filemovement">Receivers<fmt:message key="file_inward_movement.remarks" /></fmt:bundle></th> --%>
			</tr>
    </thead>
      <tbody class="tbodynew">
       <c:set var="count" value="0"></c:set>
		      ...
		      <tr>
			     <td style="text-align:center;width:8%;">${count}</td>
			     ...
			     <td style="text-align:center;width:10%;">${lifecycle.getReciever_id()}</td>
		         ...
		         <a href="../downloadfile?filename=${lifecycle.getFmt_id()}_${lifecycle.getFileName()}&folderName=${lifecycle.getFmt_id()}" >View</a> </c:if></span>
		         </td>
